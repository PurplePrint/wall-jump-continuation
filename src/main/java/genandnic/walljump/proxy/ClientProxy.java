...
import genandnic.walljump.client.*;
...
import static genandnic.walljump.client.FallingHud.showFallingHUD;
import static genandnic.walljump.client.PlayerDoubleJump.validDoubleJumpFIRST;
...
public class ClientProxy extends CommonProxy {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(new FallingHud());
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (WallJumpConfig.showFallingHud) {
            showFallingHUD = !validDoubleJumpFIRST(pl);
        }
